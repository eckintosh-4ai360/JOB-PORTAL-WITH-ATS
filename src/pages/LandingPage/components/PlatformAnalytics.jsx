...
const PlatformAnalytics = () => {
  return (
    <section className="bg-surface-card py-20 md:py-24">
          ...
          >
            {workflowItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-md bg-brand-indigo-light text-primary ring-1 ring-brand-indigo-subtle">
